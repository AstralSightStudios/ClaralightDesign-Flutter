...
class CLColorScheme {
  ...
  /// A light companion scheme derived from the same relationships.
  const CLColorScheme.light()
    : this(
        background: const Color(0xFFF2F2F2),
        panel: const Color(0xFFFFFFFF),
        frost: const Color(0xD9F7F7F7),
        control: const Color(0x14000000),
        controlHighlight: const Color(0x1F000000),
        selection: const Color(0x24000000),
        track: const Color(0x14000000),
        separator: const Color(0x1A000000),
        outline: const Color(0x26000000),
        outlineStrong: const Color(0x4D000000),
        textPrimary: const Color(0xFF1A1A1A),
        textSecondary: const Color(0xD9000000),
        textTertiary: const Color(0x99000000),
        textHint: const Color(0x66000000),
        textDisabled: const Color(0x59000000),
        accent: const Color(0xFF0082E6),
        accentBackground: const Color(0x330082E6),
        onAccent: const Color(0xFFFFFFFF),
        success: const Color(0xFF34C759),
        warning: const Color(0xFFC7871E),
        warningBackground: const Color(0x1FF4D100),
        danger: const Color(0xFFE5484D),
        dangerBackground: const Color(0x14F3000D),
        onDanger: const Color(0xFFFFFFFF),
